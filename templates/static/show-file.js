...
//Here's a function that uses an insanely long and comprehensive regex which returns a true or false value depending on whether or not the user is browsing with a mobile (and tablet).
...
function initialise() {
    ...
    if(mobileAndTabletCheck()){
        $('#inputTags').css('text-align','right');

        //keep (mobile) virtualkeyboard open when selecting suggested tags.
        $('#inputTags').on('blur',()=>{
           wasTypingTags = true;
        });
        $(document).on('click',()=>{
